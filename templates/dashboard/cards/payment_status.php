            ...
            <div class="col-md-8">
              ...
              <div class="card-body">
                  ...
                  <div class="d-inline-block w-100">
                    <a href="<?php echo esc_url( apply_filters( 'gravityformsflutterwaveaddons/project/user/dashboardpermalink', $userInfo->ID, $userInfo->data->user_nicename ) ); ?>/sign/" class="btn btn-primary mt-3"><?php esc_html_e( 'Sign the Document',   'esignbinding' ); ?></a>
                  </div>
              </div>
            </div>
            </div>
