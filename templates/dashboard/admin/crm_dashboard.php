...
<?php do_action( 'esign/project/parts/call', 'before_content' ); ?>
<div class="content-inner container-fluid pb-0" id="page_layout">
    <?php do_action( 'esign/project/admin/notices', 'content' ); ?>
    <?php do_action( 'esign/project/parts/call', 'content' ); ?>
</div>
<?php do_action( 'esign/project/parts/call', 'aft_ercontent' ); ?>
