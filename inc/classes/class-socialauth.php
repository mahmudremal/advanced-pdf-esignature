...
class SocialAuth {
	...
	protected function setup_hooks() {
		$this->facebookAppID					= apply_filters( 'esign/project/system/getoption', 'auth-googleclientid', 'facebook-app-id' );
		$this->facebookAppSecret			= apply_filters( 'esign/project/system/getoption', 'auth-googleclientid', 'facebook-app-secret' );
		...
		add_filter( 'esign/project/socialauth/redirect', [ $this, 'socialAuthRedirect' ], 10, 2 );
		add_filter( 'esign/project/socialauth/link', [ $this, 'socialAuthLink' ], 0, 2 );
		...
		if( ! apply_filters( 'esign/project/system/isactive', 'auth-enable' ) ) {return;}
		/**
		 * Actions.
		 */
    ...
    $auth_provider = get_query_var( 'auth_provider' );
      ...
      return $template;
			...
			$file = ESIGNBINDING_ADDONS_DIR_PATH . '/templates/auth/index.php';
