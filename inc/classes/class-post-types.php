...
class Post_Types {
	...
	public function create_esignature_cpt() {
		$icon = untrailingslashit(ESIGNBINDING_ADDONS_BUILD_PATH.'/icons/contract-document-svgrepo-com.svg');
		$icon = (file_exists($icon)&&!is_dir($icon))?esc_url(ESIGNBINDING_ADDONS_BUILD_URI.'/icons/contract-document-svgrepo-com.svg'):'dashicons-superhero';
