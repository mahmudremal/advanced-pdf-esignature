...
class Flutterwave {
	...
	protected function __construct() {
        ...
        $this->is_test_mode = ESIGNBINDING_ADDONS_TEST_MODE;
	...
	public function template_include( $template ) {
		...
		$file				= ESIGNBINDING_ADDONS_DIR_PATH . '/templates/dashboard/cards/flutterwave.php';
    ...
    public function add_flutterwave_gateway($gateways) {
        $gateways[] = 'ESIGNBINDING_ADDONS\Inc\Woo_Flutter';
        return $gateways;
    }
