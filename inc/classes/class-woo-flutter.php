...
class Woo_Flutter extends \WC_Payment_Gateway {
	...
	public function get_icon() {
		// $icon = '<img src="'.esc_url(ESIGNBINDING_ADDONS_BUILD_IMG_URI.'/trusted-by-flutterwave.png').'" alt="cards"/>';
		$icon = 'gform-icon gform-icon--api';
		// $icon = ESIGNBINDING_ADDONS_BUILD_PATH . '/src/icons/money-business-and-finance-svgrepo-com.svg';
	...
	public function init_form_fields() {
		...
		$this->form_fields = array(
			'enabled'            => array(
				...
				'label'       => __( 'Switch on this field to enable Flutterwave payment on your gravity forms and woocommerce.', 'esignbinding' ),
				'type'        => 'checkbox',
				'description' => __( 'Enable Flutterwave as a payment option on your gravity forms and checkout page.', 'esignbinding' ),
				'default'     => 'no',
				'desc_tip'    => true,
			),
			'title'              => array(
				'title'       => __( 'Checkout page title', 'esignbinding' ),
				'type'        => 'text',
				'description' => __( 'The payment method title which will be apear on the checkout screen.', 'esignbinding' ),
				'desc_tip'    => true,
				'default'     => __( 'Flutterwave', 'esignbinding' ),
			),
			'description'        => array(
				'title'       => __( 'Description', 'esignbinding' ),
				'type'        => 'textarea',
				'description' => __( 'This controls the payment method description which the user sees during checkout.', 'esignbinding' ),
				'desc_tip'    => true,
				'default'     => __( 'Make payment using your debit, credit card & bank account', 'esignbinding' ),
			),
			'testmode'           => array(
				'title'       => __( 'Test mode', 'esignbinding' ),
				'label'       => __( 'Enable Test Mode', 'esignbinding' ),
				'type'        => 'checkbox',
				'description' => __( 'Test mode enables you to test payments before going live. <br />Once you are live uncheck this.', 'esignbinding' ),
				'default'     => 'yes',
				'desc_tip'    => true,
			),
			'test_public_key'    => array(
				'title'       => __( 'Test Public Key', 'esignbinding' ),
				'type'        => 'text',
				'description' => __( 'Required: Enter your Test Public Key here.', 'esignbinding' ),
				'default'     => '',
				'desc_tip'    => true,
			),
			'test_secret_key'    => array(
				'title'       => __( 'Test Secret Key', 'esignbinding' ),
				'type'        => 'password',
				'description' => __( 'Required: Enter your Test Secret Key here', 'esignbinding' ),
				'default'     => '',
				'desc_tip'    => true,
			),
			'live_public_key'    => array(
				'title'       => __( 'Live Public Key', 'esignbinding' ),
				'type'        => 'text',
				'description' => __( 'Required: Enter your Live Public Key here.', 'esignbinding' ),
				'default'     => '',
				'desc_tip'    => true,
			),
			'live_secret_key'    => array(
				'title'       => __( 'Live Secret Key', 'esignbinding' ),
				'type'        => 'password',
				'description' => __( 'Required: Enter your Live Secret Key here.', 'esignbinding' ),
				'default'     => '',
				'desc_tip'    => true,
			),
			'custom_title'       => array(
				'title'       => __( 'Model Title', 'esignbinding' ),
				'type'        => 'text',
				'description' => __( 'Optional: Text to be displayed as the title of the payment modal.', 'esignbinding' ),
				'default'     => '',
				'desc_tip'    => true,
			),
			'custom_desc'        => array(
				'title'       => __( 'Custom Description', 'esignbinding' ),
				'type'        => 'text',
				'description' => __( 'Optional: Text to be displayed as a short modal description.', 'esignbinding' ),
				'default'     => '',
				'desc_tip'    => true,
			),
			'custom_logo'        => array(
				'title'       => __( 'Custom Logo', 'esignbinding' ),
				'type'        => 'text',
				'description' => __( 'Optional: Enter the link to a image to be displayed on the payment popup. Preferably a square image.', 'esignbinding' ),
				'default'     => '',
				'desc_tip'    => true,
			),
			'saved_cards'        => array(
				'title'       => __( 'Saved Cards', 'esignbinding' ),
				'label'       => __( 'Enable Payment via Saved Cards', 'esignbinding' ),
				'type'        => 'checkbox',
				'description' => __( 'If enabled, users will be able to pay with a saved card during checkout. Card details are saved on Flutterwave servers, not on your store.<br>Note that you need to have a valid SSL certificate installed.', 'esignbinding' ),
				'default'     => 'no',
				'desc_tip'    => true,
			),
			'autocomplete_order' => array(
				'title'       => __( 'Autocomplete Order After Payment', 'esignbinding' ),
				'label'       => __( 'Autocomplete Order', 'esignbinding' ),
				'type'        => 'checkbox',
				'description' => __( 'If enabled, the order will be marked as complete after successful payment', 'esignbinding' ),
				'default'     => 'no',
				'desc_tip'    => true,
			),
			'autoconfirm_order' => array(
				'title'       => __( 'Auto Confirm', 'esignbinding' ),
				'label'       => __( 'Autoconfirm Order After successful Payment from checkout page', 'esignbinding' ),
				'type'        => 'checkbox',
				'description' => __( 'If enabled, the order will be marked as paid after successful payment', 'esignbinding' ),
				'default'     => 'no',
				'desc_tip'    => true,
			),
			'autosubmit_form' => array(
				'title'       => __( 'Auto Submit', 'esignbinding' ),
				'label'       => __( 'Auto submit form after payment successful. Disable recommanded.', 'esignbinding' ),
				'type'        => 'checkbox',
				'description' => __( 'If enabled, all of the form will be submitted by default after successful payment. Disabling this field comes with a possibility to define this auto submit features from single form settings.', 'esignbinding' ),
				'default'     => 'no',
				'desc_tip'    => true,
			),
		);
	...
	public function display_flutterwave_fee( $order_id ) {
        ...
        <tr>
            <td class="label rave-fee">
				<?php echo wc_help_tip( __( 'This represents the fee Flutterwave collects for the transaction.', 'esignbinding' ) ); ?>
				<?php esc_html_e( __( 'Flutterwave Fee:', 'esignbinding' ) ); ?>
            </td>
            <td width="1%"></td>
            <td class="total">
	...
	public function display_order_payout( $order_id ) {
        ...
        <tr>
            <td class="label rave-payout">
				<?php $message = __( 'This represents the net total that will be credited to your bank account for this order.', 'esignbinding' ); ?>
				<?php if ( $net >= $order->get_total() ) : ?>
					<?php $message .= __( ' Flutterwave transaction fees was passed to the customer.', 'esignbinding' ); ?>
				<?php endif; ?>
				<?php echo wc_help_tip( $message ); ?>
				<?php esc_html_e( __( 'Flutterwave Payout:', 'esignbinding' ) ); ?>
            </td>
            <td width="1%"></td>
            <td class="total">
	...
	public function process_payment( $order_id ) {
		...
		if ( isset( $_POST['wc-tbz_rave-payment-token'] ) && 'new' !== $_POST['wc-tbz_rave-payment-token'] ) {
			...
			if ( $token->get_user_id() !== get_current_user_id() ) {
				...
				wc_add_notice( __( 'Invalid token ID', 'esignbinding' ), 'error' );
	...
	public function add_payment_method() {
		wc_add_notice( __( 'You can only add a new card when placing an order.', 'esignbinding' ), 'error' );
	}
