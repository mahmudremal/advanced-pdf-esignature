...
class GF_FlutterWave_Credit_Card_Field extends \GF_Field {
    ...
    public function get_form_editor_field_icon() {
        ...
        return file_get_contents(ESIGNBINDING_ADDONS_BUILD_PATH . '/icons/money-business-and-finance-svgrepo-com.svg');
	}
    ...
    public function get_field_input($form, $value = '', $entry = null) {
        ...
        wp_enqueue_script('esignscripts');ob_start();
        ...
        ?>
            ...
            <!-- <script src="<?= ESIGNBINDING_ADDONS_BUILD_LIB_URI.'/js/imask.min.js'; ?>"></script> -->
    ...
    public function plugin_settings_fields() {
        return array(
            array(
                'title'  => esc_html__('Flutterwave Settings', 'esignbinding'),
                'fields' => array(
                    array(
                        'name'              => 'mytextbox',
                        'tooltip'           => esc_html__('This is the tooltip', 'esignbinding'),
                        'label'             => esc_html__('This is the label', 'esignbinding'),
                        'type'              => 'text',
                        'class'             => 'small',
    ...
    public function form_settings_fields( $form ) {
        return array(
            array(
                ...
                'fields' => array(
                    array(
                        'label'   => esc_html__('My checkbox', 'esignbinding'),
                        'type'    => 'checkbox',
                        'name'    => 'enabled',
                        'tooltip' => esc_html__('This is the tooltip', 'esignbinding'),
                        'choices' => array(
                    ...
                    array(
                        'label'   => esc_html__('My checkboxes', 'esignbinding'),
                        'type'    => 'checkbox',
                        'name'    => 'checkboxgroup',
                        'tooltip' => esc_html__('This is the tooltip', 'esignbinding'),
                        'choices' => array(
                            array(
                                'label' => esc_html__('First Choice', 'esignbinding'),
                                'name'  => 'first',
                            ),
                            array(
                                'label' => esc_html__('Second Choice', 'esignbinding'),
                                'name'  => 'second',
                            ),
                            array(
                                'label' => esc_html__('Third Choice', 'esignbinding'),
                                'name'  => 'third',
                            ),
                        ),
                    ),
                    array(
                        'label'   => esc_html__('My Radio Buttons', 'esignbinding'),
                        'type'    => 'radio',
                        'name'    => 'myradiogroup',
                        'tooltip' => esc_html__('This is the tooltip', 'esignbinding'),
                        'choices' => array(
                    ...
                    array(
                        'label'      => esc_html__('My Horizontal Radio Buttons', 'esignbinding'),
                        'type'       => 'radio',
                        'horizontal' => true,
                        'name'       => 'myradiogrouph',
                        'tooltip'    => esc_html__('This is the tooltip', 'esignbinding'),
                    ...
                    array(
                        'label'   => esc_html__('My Dropdown', 'esignbinding'),
                        'type'    => 'select',
                        'name'    => 'mydropdown',
                        'tooltip' => esc_html__('This is the tooltip', 'esignbinding'),
                        'choices' => array(
                    ...
                    array(
                        'label'             => esc_html__('My Text Box', 'esignbinding'),
                        'type'              => 'text',
                        'name'              => 'mytext',
                        'tooltip'           => esc_html__('This is the tooltip', 'esignbinding'),
                        'class'             => 'medium',
                    ...
                    array(
                        'label'   => esc_html__('My Text Area', 'esignbinding'),
                        'type'    => 'textarea',
                        'name'    => 'mytextarea',
                        'tooltip' => esc_html__('This is the tooltip', 'esignbinding'),
                    ...
                    array(
                        'label' => esc_html__('My Hidden Field', 'esignbinding'),
                        'type'  => 'hidden',
                        'name'  => 'myhidden',
                    ),
                    array(
                        'label' => esc_html__('My Custom Field', 'esignbinding'),
                        'type'  => 'my_custom_field_type',
                        'name'  => 'my_custom_field',
                        'args'  => array(
                            'text'     => array(
                                'label'         => esc_html__('A textbox sub-field', 'esignbinding'),
                                'name'          => 'subtext',
                                'default_value' => 'change me',
                            ),
                            'checkbox' => array(
                                'label'   => esc_html__('A checkbox sub-field', 'esignbinding'),
                                'name'    => 'my_custom_field_check',
                                'choices' => array(
                                    array(
                                        'label'         => esc_html__('Activate', 'esignbinding'),
                                        'name'          => 'subcheck',
                                        'default_value' => true,
                                    ),
                                ),
